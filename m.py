...
TOKEN = '7125514283:AAEtBoyBFw29Ol6n6P-uoR6z0h3Hzn7cWhA'
...
def send_welcome(message):
    ...
    bot.send_message(message.chat.id, "*🔆 WELCOME TO VIP OM DDOS BOT 🔆*", reply_markup=markup, parse_mode='Markdown')
